...
<style type="text/css">
.breadcrumbs-v1.img-repast {
	background: url("public/images/repast.jpg") no-repeat;
...
<body class="header-fixed header-fixed-space-v2" data-spy="scroll"
	...
	<div class="wrapper">
		...
		<%
			...
			if (con != null) {
		%>
		<div class="breadcrumbs-v1 img-repast margin-bottom-30">
			<div class="container" style="text-align: center">
				<h1 class="pull-center"><%=con.getCon_name()%></h1>
			</div>
		</div>
		<div class="container" style="margin-bottom: 160px; margin-top: 30px;">
			<div class="headline">
				<h2>就餐安排</h2>
				<p><%=con.getCon_repast() %></p>
			</div>
		</div>
