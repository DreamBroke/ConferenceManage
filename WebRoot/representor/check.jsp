						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
								<div class="header">
									...
									<a href="mycheck.jsp" class="btn btn-info" style="float: right;">我的预订</a>
								...
								<div class="content">
									<div class="row">
										<%
											...
											for(Hotel h : al){
										%>
										<div class="col-md-5" style="margin: 40px; padding-bottom:20px; border: 2px solid #E3E3E3;">
											<h4><%=h.getHot_name()%></h4>
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label>联系电话</label> <input type="text" disabled="disabled"
												...
												<div class="col-md-6">
													<div class="form-group">
														<label>价格范围</label> <input type="text" disabled="disabled"
															class="form-control border-input"
															value="<%=h.getHot_capital()%>">
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-md-12">
													<div class="form-group">
														...
														<textarea disabled="disabled"
															class="form-control border-input"><%=h.getHot_address()%></textarea>
													</div>
												</div>
											</div>
											<div class="text-center">
												<a href="room.jsp?hot_no=<%=h.getHot_no()%>" class="btn btn-info btn-fill btn-wd">选择</a>
											</div>
										</div>
										<%
											}
